...
function nouvelEtat() {
  ...
  return {
    ...
    chanceActuelle: 0,
    dlcDebloques: [],
    stats: { boitesOuvertesTotal: 0, orGagneTotal: 0, fusionsTotal: 0, boitesVenduesTotal: 0, cheatsUtilises: 0, xp: 0 },
...
function construireSucces() {
  ...
  liste.push({ id: "or_500", titre: "Petit pécule", description: "Gagne 500 or au total.", recompense: 40, condition: () => state.stats.orGagneTotal >= 500 });
  liste.push({ id: "or_5000", titre: "Bourse bien garnie", description: "Gagne 5 000 or au total.", recompense: 250, condition: () => state.stats.orGagneTotal >= 5000 });
  liste.push({ id: "or_50000", titre: "Fortune", description: "Gagne 50 000 or au total.", recompense: 1500, condition: () => state.stats.orGagneTotal >= 50000 });
